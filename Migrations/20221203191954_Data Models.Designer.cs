...
namespace IssueTracker.Migrations
{
    ...
    [Migration("20221203191954_Data Models")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IssueTracker.Models.BTUser", b =>
                {
                    ...
                    b.Property<string>("AvatarFormName")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("BTUserProject", b =>
                {
                    b.HasOne("IssueTracker.Models.BTUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("IssueTracker.Models.Invite", b =>
                {
                    ...
                    b.HasOne("IssueTracker.Models.BTUser", "Invitee")
                        .WithMany()
                        .HasForeignKey("InviteeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("IssueTracker.Models.BTUser", "Invitor")
                        .WithMany()
            ...
            modelBuilder.Entity("IssueTracker.Models.Notification", b =>
                {
                    b.HasOne("IssueTracker.Models.BTUser", "Recipient")
                        .WithMany()
                        .HasForeignKey("RecipientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("IssueTracker.Models.BTUser", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("IssueTracker.Models.Ticket", b =>
                {
                    b.HasOne("IssueTracker.Models.BTUser", "DeveloperUser")
                        .WithMany()
                        .HasForeignKey("DeveloperUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("IssueTracker.Models.BTUser", "OwnerUser")
                        .WithMany()
            ...
            modelBuilder.Entity("IssueTracker.Models.TicketAttachment", b =>
                {
                    ...
                    b.HasOne("IssueTracker.Models.BTUser", "User")
                        .WithMany()
