...
namespace IssueTracker.Services
{
    ...
    public class BTNotification : IBTNotificationService
    {
        ...
        public async Task<List<Notification>> GetRecievedNotificaitonsAsync(string userId)
        {
            try
            {
        ...
        public async Task<List<Notification>> GetSentNotificaitonsAsync(string userId)
        {
            try
            {
                List<Notification> notifications = await _context.Notifications
